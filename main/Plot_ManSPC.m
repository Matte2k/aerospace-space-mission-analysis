...
run('ManovraSPC.m')                         % Calcolo dati manovra
...
if (theta_1 < theta_2)
    theta_vect_man2 = (theta_1:offset_Plot:theta_2)';
elseif (theta_1 > theta_2)
    theta_vect_man2 = (theta_1:offset_Plot:(2*pi + theta_2))';
elseif (theta_1 == theta_2)
    theta_vect_man2 = 0;
end
...
% Vettore Theta Orbita_3 percorsa
if (theta_2 < theta_3)
    theta_vect_man3 = (theta_2:offset_Plot:theta_3)';
elseif (theta_2 > theta_3)
    theta_vect_man3 = (theta_2:offset_Plot:(2*pi + theta_3))';
elseif (theta_2 == theta_3)
    theta_vect_man3 = 0;
end
...
% Inizializzazione vettori posizione e velocità Orbita_circolare
...
% Calcolo vettore posizione e velocità Orbita_circolare
...
% Vettori plot Orbita_circolare
X_Orbita_circ = R_circ(1,:);
Y_Orbita_circ = R_circ(2,:);
Z_Orbita_circ = R_circ(3,:);

% Calcolo vettore posizione Orbita_circolare completa
...
% Vettori plot Orbita_circolare completa
...
if (theta_3 < theta_f)
    theta_vect_f = (theta_3:offset_Plot:theta_f)';
elseif (theta_3 > theta_f)
    theta_vect_f = (theta_3:offset_Plot:(2*pi + theta_f))';
elseif (theta_3 == theta_f)
    theta_vect_f = 0;
end
