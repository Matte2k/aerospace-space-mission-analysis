...
run('Plot_ManSPA.m')                        % Plot statico manovra

% Vettore Theta Orbita_tot percorsa
theta_vect_tot = [theta_vect_i;theta_vect_man1;theta_vect_man2;theta_vect_man3;theta_vect_f];
...
X_Orbita_tot = [X_Orbita_i,X_Orbita_1,X_Orbita_2,X_Orbita_3,X_Orbita_f];
Y_Orbita_tot = [Y_Orbita_i,Y_Orbita_1,Y_Orbita_2,Y_Orbita_3,Y_Orbita_f];
Z_Orbita_tot = [Z_Orbita_i,Z_Orbita_1,Z_Orbita_2,Z_Orbita_3,Z_Orbita_f];
...
ylabel('Y [km]')
zlabel('Z [km]')
title('3D animation Manovra SPA')
view( [1 1 1] )
...
filename = 'Animated_ManSPA.gif';       % Fix the local Path: '...\MediaOpt\Animated_orb_i.gif'
for k_frame = 1:length(theta_vect_frame)
