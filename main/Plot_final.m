...
run('ManovraPAS.m')                         % Calcolo dati manovra
...
if (Start_Bitan == 1)
    if theta_4 < pi
        theta_vect_man2 = (theta_4:offset_Plot:pi)';
    elseif theta_4 > pi
        theta_vect_man2 = (theta_4:offset_Plot:(2*pi+pi))';
    elseif (theta_4 == pi)
        theta_vect_man2 = 0;
    end
elseif (Start_Bitan == 0)  
    if (theta_4 == 0) || (theta_4 == 2*pi)
        theta_vect_man2 = 0;
    else
        theta_vect_man2 = (theta_4:offset_Plot:2*pi)';
    end       
end
...
% Plot Orbita_i 3D
   ...
   plot3(X_Orbita_i_cmpl,Y_Orbita_i_cmpl,Z_Orbita_i_cmpl,'LineWidth',2.0,'Color','r')                      % Orbita completa
...
%
%     % Plot Orbita_2 3D
%     plot3(X_Orbita_2,Y_Orbita_2,Z_Orbita_2,'LineWidth',1.0,'Color','m')                                     % Orbita percorsa
...
% 
%     % Plot Orbita_3 3D
%     plot3(X_Orbita_3,Y_Orbita_3,Z_Orbita_3,'LineWidth',1.0,'Color','c')                                     % Orbita percorsa
...
% 
%     % Plot Orbita_f 3D
%     plot3(X_Orbita_f,Y_Orbita_f,Z_Orbita_f,'LineWidth',1.0,'Color','b')                                           % Orbita percorsa
      plot3(X_Orbita_f_cmpl,Y_Orbita_f_cmpl,Z_Orbita_f_cmpl,'LineWidth',2.0,'Color','b')                            % Orbita completa
